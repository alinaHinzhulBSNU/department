...
@section('content')
<h4 class="text-danger text-center p-3">Додати дані про дисципліну</h4>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <form method="post" action="/subjects">
                ...
                <!--Назва дисципліни-->
                @include("includes/input", ['id' => 'name', 
                'label' => 'Назва дисципліни:', 'name' => 'Введіть назву'])

                <!--Опис дисципліни-->
                @include("includes/input", ['id' => 'description', 
                'label' => 'Опис дисципліни:', 'name' => 'Введіть опис'])

                <!--Кредит дисципліни-->
                @include("includes/input", ['id' => 'credit', 
